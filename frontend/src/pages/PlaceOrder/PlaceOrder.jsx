...
import { useNavigate } from 'react-router-dom'; // Add this if you plan to use navigate
...
const PlaceOrder = () => {
    ...
    const navigate = useNavigate(); // Add this if you plan to use navigate
    ...
    const onSubmitHandler =async (event) => {
        ...
        if(response.data.success){
            ...
            navigate('/orders'); // Add this if you plan to use navigate
        }else{
            alert("Error");
        }
    };
